...
public sealed record TransportQuoteDto(Guid Id, PartnerReference Carrier, decimal Price, string Currency, DateOnly? PickupOn, DateOnly? DeliveryOn, bool IsSelected, string? Notes);
