...
[ApiController]
[Route("api/emails")]
public sealed class EmailsController(IEmailQueryService queries, IEmailCommandService commands, IEmailSyncService sync, IEmailSender sender, IEmailProcessor processor, BcgHubDbContext db, CurrentUserAccessor currentUser) : ControllerBase
{
    [HttpGet]
