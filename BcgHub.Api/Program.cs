...
builder.Services.AddSingleton<IPohodaSyncService, PohodaSyncService>();
builder.Services.AddHostedService<PohodaSyncBackgroundWorker>();
...
builder.Services.AddScoped<IEmailPartnerSuggestionService, EmailPartnerSuggestionService>();
